...
int main() {
    ...
    float densidadepopulacional = (float)populacao/area, soma = (float)populacao + area;
    ...
    int numerodepontosturisticos2 = 30, opcao2;
    float densidadepopulacional2 = (float)populacao2/area2, soma2 = (float)populacao2 + area2;
    srand(time(0));
...
printf("Valores do atributo de São paulo: %d e %.2f\n", populacao, area);
printf("Soma: %.2f\n", soma);
printf("Valores do atributo do Rio de Janeiro: %d e %.2f\n", populacao2, area2);
printf("Soma: %.2f\n", soma2);
    
if (soma > soma2){
    printf("São Paulo Ganhou!\n");
} else if (soma == soma2){
    printf("Empatou.\n");
} else {
